              ...
              <div className="mt-5">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-sm mt-2 opacity-50">
                    {data.resume.education.universityPara1}
                  </p>
                  <p className="text-sm mt-2 opacity-50">
                    {data.resume.education.universityPara2}
                  </p>
                  <p className="text-sm mt-2 opacity-50">
                    {data.resume.education.universityPara3}
                  </p>
                </div>
              </div>
              <div className="mt-5">
                ...
                <div className="flex mob:flex-col desktop:flex-row justify-between">
                  ...
                  {data.resume.frameworks && (
                    <div className="mt-2 mob:mt-5">
                      <h2 className="text-lg">Frameworks & Technologies</h2>
                      <ul className="list-disc">
                  ...
                  {data.resume.others && (
                    <div className="mt-2 mob:mt-5">
                      <h2 className="text-lg">Web Design</h2>
                      <ul className="list-disc">
